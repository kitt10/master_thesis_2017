...
Moreover, we decipher the matrices of weights and biases. The call $ W $ the vector of weight matrices $ W^{(i)} $, where $ W $ is always of length $ (q+1) $, where $ q $ is the number of hidden layers.
\begin{align*}
