...
%In 1943, two scientists, neurophysiologist Warren S. McCulloch and mathematician Walter Pitts, impressed by the simplicity of single biological neurons, inspired the world of AI with their publication of a simplified artificial neuron model in \citep{mcculloch:neuron}.
