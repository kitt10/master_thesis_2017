...
The process of speech data gathering is described in \cref{sec:speech_data_gathering}. The dataset generation process has three parameters: \texttt{border\textunderscore size}, \texttt{context\textunderscore size} and \texttt{n\textunderscore samples}.

In this example, at first we try to find optimal parameter settings for the dataset generation, which would lead to the maximal trainability.
