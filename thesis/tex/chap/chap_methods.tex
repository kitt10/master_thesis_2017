...
Talking about \cref{fig:methods:feature_vector}, features $ g_1, g_2, ..., g_{200} $ represent a feature vector of one sample, which takes the label of the base frame.
