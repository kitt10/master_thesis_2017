...
The general workflow of the pruning procedure is illustrated in \cref{fig:methods:network_pruning_flowchart}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{network_pruning_flowchart}
  \caption{The flowchart of network pruning proceeder.}
...
So far we gave a recipe of how to prune one synapse. In practise, network pruning is an iterative procedure.
